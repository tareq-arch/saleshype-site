...
export const metadata: Metadata = {
  ...
  description: "Fully managed B2B outbound lead generation for UK founders. Sales Hype builds targeted prospect lists, cold email sequences, deliverability and HubSpot pipeline reporting.",
...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="Sales Hype builds and runs the outbound system: targeted prospect data, written sequences, protected sending infrastructure, deliverability management, HubSpot integration and weekly pipeline reporting. Built for B2B services with real deal value, not vanity lead volume."
      ...
      bullets={["ICP and market mapping before any list is built.", "Prospect data built with decision-maker focus.", "Cold email copy written in a direct founder/operator voice.", "Protected sending infrastructure for cold outreach.", "Deliverability monitoring and controlled sending volume.", "HubSpot pipeline setup for interested replies and weekly reporting."]}
      faqs={[
        { question: "What is B2B outbound lead generation?", answer: "B2B outbound lead generation is the process of identifying specific target companies and decision-makers, contacting them directly, and turning positive replies into sales conversations. Sales Hype manages this through modern data tools, cold email infrastructure and HubSpot." },
