...
export default function Page() {
  return (
    <SeoLandingPage
      ...
      description="Sales Hype reviews the health of your outbound setup before volume scales: sending domains, inbox reputation, list quality, campaign behaviour and how replies move into HubSpot. You get a clear diagnosis, not a public playbook."
      ...
      bullets={["Review of sending domain and inbox risk", "Checks for avoidable authentication and reputation problems", "Assessment of list quality before launch", "Review of campaign behaviour and early volume risk", "HubSpot reply-routing and ownership review", "Plain-English diagnosis of what should be fixed first", "Managed outbound setup available for teams that want it handled", "Built for B2B founders selling into the UK and GCC"]}
      faqs={[
